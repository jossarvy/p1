<!--link rel="stylesheet" href="assets\css/pol.css"-->
<div class="row">
	<div class="col-md-12 col-sm-12 clearfix" style="text-align:center;">
		<p class="ok">

		<strong>
		<h2 style="font-weight:10; margin:-7px; color:#435043; text-align:right;font-size:20px"><?php echo $system_name;?></h2>
		</strong>
		</p>
	</div>
	<!-- Raw Links -->
           ...
           <li class="dropdown language-selector">
			...
			<li>
				<a href="<?php echo base_url();?>index.php?login/logout">
					déconnecter <i class="entypo-logout left"></i>
				</a>
			</li>
		</ul>
	</div>
