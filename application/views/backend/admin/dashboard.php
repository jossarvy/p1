		...
		<div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-blue">
                    ...
                    <h3><?php echo ('Enseignant Actifs');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-green">
                    ...
                    <h3><?php echo ('Présence du jour');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-black">
                    ...
                    <h3><?php echo ('Classes disponibles');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-brown">
                    ...
                    <h3><?php echo ('Frais non payés');?></h3>
                ...
                <div class="panel panel-primary " data-collapsed="0">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <?php echo get_phrase("calendrier d'événements");?>
                        </div>
                    </div>
