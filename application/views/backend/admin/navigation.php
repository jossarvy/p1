    ...
    <header class="logo-env" >
        ...
        <div class="logo" style="">
            <a href="<?php echo base_url(); ?>">
                <img src="uploads/logo.png"  style="max-height:130px;"/>
            </a>
        </div>
    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Gestion des classes'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'class') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/classes">
                        <span><i class="entypo-dot"></i> <?php echo ('Ajouter une classe'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'section') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/section">
                        <span><i class="entypo-dot"></i> <?php echo ('Ajouter une Section/Option'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if ($page_name == 'class_routine') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/class_routine">
                ...
                <span><?php echo ('Horaire de cours '); ?></span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Gestion Elève'); ?></span>
            </a>
            <ul>
                <!-- STUDENT ADMISSION -->
                ...
                <li class="<?php if ($page_name == 'student_add') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_add">
                        <span><i class="entypo-dot"></i> <?php echo ('Ajouter un élève'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_bulk_add') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_bulk_add">
                        <span><i class="entypo-dot"></i> <?php echo ('Ajouter Elève par fichier'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_information') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo ('Information des Elèves'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
                ...
                <li class="<?php if ($page_name == 'student_marksheet') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo ('Cotation des élèves'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
        ...
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/teacher">
                ...
                <span><?php echo ('Panel pour Enseignant'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'manage_attendance') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/manage_attendance/<?php echo date("d/m/Y"); ?>">
                ...
                <span><?php echo ('Présence du Jour'); ?></span>
            </a>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Les examens'); ?></span>
            </a>
            <ul>
        ...
        <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/invoice">
                ...
                <span><?php echo ('Paiement et Facturation'); ?></span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Comptabilité'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'income') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/income">
                        <span><i class="entypo-dot"></i> <?php echo ('Revenus'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'expense') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/expense">
                        <span><i class="entypo-dot"></i> <?php echo ('Depenses'); ?></span>
                    </a>
                </li>
