...
<div class="login-container" style="margin:30% ; background-color:#9cd8b9;">
	
	<div class="login-header login-caret" style="margin-top:-490px;">
		...
		<div class="login-content" style="width:100%;">
			...
			<A href="<?php echo base_url();?>" class="logo">
				<img src="uploads/logog.png" height="50" alt="ploads/logou.jpg" />
			</A>
			<p class="description">
